package com.voltaras.meterreadingservice.config;
...
/**
 * CORS configuration so the frontend development server and the
 * API Gateway can call this service directly.
 */
@Configuration
